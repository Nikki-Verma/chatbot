...
function Message({message, loading, chatStreaming, chatConfig}: any) {
  ...
  return (
    <View
      style={
        message?.role === 'user'
          ? messageStyle.UserMessageContainer
          : messageStyle.BotMessageContainer
      }>
      {!isBot ? (
        ...
        <View style={messageStyle.infoContainer}>
          {/* <SimplaiIcon
            ...
            alt=""
            /> */}
          <Text style={messageStyle.botName}>{chatConfig?.model ?? 'Bot'}</Text>
        </View>
      )}
      {loading ? (
        <View
        ...
        <View
          style={
            message?.role === 'user'
              ? messageStyle.UserMessage
              : messageStyle.BotMessage
          }
          role={message?.role}>
          {message?.content ? (
            <>
